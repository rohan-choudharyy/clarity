      ...
      <div className="container px-4 sm:px-6 lg:px-8" ref={containerRef}>
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              Unify retail media into one plan, one budget, one report — with measurable ROAS at SKU level.
            </p>
            ...
            >
              ...
              <a 
                href="#contact" 
                className="flex items-center justify-center group w-full sm:w-auto text-center mt-4 sm:mt-0" 
                style={{
            ...
            {lottieData ? (
              <div className="relative z-10 animate-fade-in" style={{ animationDelay: "0.9s" }}>
                <img 
                  ...
                  className="w-full h-auto object-cover transition-transform duration-500 ease-out rounded-2xl sm:rounded-3xl shadow-2xl" 
